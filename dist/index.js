 ...
 */
async function runPythonClient(args) {
        ...
        return {
            tools: [
                ...
                },
                {
                    ...
                    description: "Get information about the current iTerm2 pane where the MCP server is running",
                    inputSchema: {
                        type: "object",
                        properties: {},
                        required: [],
                ...
                },
                {
                    ...
                    description: "Enable the iTerm2 Python API in preferences. Note: iTerm2 must be restarted after enabling.",
                    inputSchema: {
                        type: "object",
                        properties: {},
                        required: [],
