          ...
          inputSchema: {
            ...
            properties: {
              session_id: {
                type: "string",
                description:
                  "The session ID of the pane to send text to (e.g., 'w0t0p0:ABC123...'). Use iterm2_list_panes to find session IDs.",
              },
              text: {
                type: "string",
          ...
          inputSchema: {
            ...
            properties: {
              session_id: {
                type: "string",
                description:
                  "The session ID of the pane to send the control character to.",
              },
              control: {
                type: "string",
                enum: ["c", "d", "z", "l"],
